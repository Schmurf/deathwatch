...
import { DEATHWATCH } from './helpers/config.mjs';
...
Hooks.once('init', function () {
  ...
  CONFIG.Item.dataModels = {
    item: models.DeathwatchItem,
    feature: models.DeathwatchFeature,
    spell: models.DeathwatchSpell
  }
  ...
  Actors.registerSheet('deathwatch', DeathwatchActorSheet, {
    makeDefault: true,
    label: 'DEATHWATCH.SheetLabels.Actor',
  });
  Items.unregisterSheet('core', ItemSheet);
  Items.registerSheet('deathwatch', DeathwatchItemSheet, {
    makeDefault: true,
    label: 'DEATHWATCH.SheetLabels.Item',
  });
